package demo.spring.mybatis.generator.mapper;
...
public interface CoffeeMapper {
     ...
     *
     * @mbg.generated Tue Aug 27 23:36:28 CST 2019
     */
    ...
    @Insert({
        ...
        "values (#{name,jdbcType=VARCHAR}, #{price,jdbcType=BIGINT,typeHandler=demo.spring.mybatis.generator.handler.MoneyTypeHandler}, ",
    ...
    @ResultMap("demo.spring.mybatis.generator.mapper.CoffeeMapper.BaseResultMap")
    ...
    @Update({
        ...
        "set NAME = #{name,jdbcType=VARCHAR},",
          "PRICE = #{price,jdbcType=BIGINT,typeHandler=demo.spring.mybatis.generator.handler.MoneyTypeHandler},",
